    ...
    return `
      <div class="post item-card">
        <div class="post-header">
          ...
          <span class="hit">조회수: 45</span>
          <span class="wdate">2025-09-29</span>
        </div>
        <div class="post-body">
          <div class="item-row" style="display:flex; gap:12px; align-items:center;">
            <img src="gae.jpg" alt="icon" style="width:80px;height:80px;border-radius:8px;object-fit:cover;">
            <div style="flex:1;">
      ...
      <div class="post item-card">
        ...
        <div class="post-body">
          <div class="item-row" style="display:flex; gap:12px; align-items:center;">
            <img src="gnlwkd.png" alt="bg" style="width:120px;height:80px;border-radius:8px;object-fit:cover;">
            <div style="flex:1;">
